...
presiona en el siguiente link para ver <a href="https://api-invert-string.herokuapp.com/iecho?text=/iecho?text=Dábale arroz a la zorra el abad" title="API link" target="_blank">invert-string API</a>
